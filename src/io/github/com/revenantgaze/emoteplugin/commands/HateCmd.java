...
public class HateCmd implements CommandExecutor {
	
	public Main plugin;
	
	public HateCmd(Main instance) {
			...
			if (Cooldown.tryCooldown(you, "MagicHand", (CooldownValue * 1000))) {
	            ...
	            if (args.length == 1 && (Bukkit.getPlayerExact(args[0]) != null)){
	    		    ...
	    		    String user2 = target.getName();
	    		    	...
	    		    	Bukkit.getServer().broadcastMessage(ChatColor.GOLD + "[Emotes] " + ChatColor.GREEN + user1 + " hates " + user2 + "! Why so angry?");
	    			...
	    			String user1 = you.getName();	
	    		        ...
	    		        Bukkit.getServer().broadcastMessage(ChatColor.GOLD + "[Emotes] " + ChatColor.GREEN + user1 + " hates everybody, just like grumpy cat!");    		        
