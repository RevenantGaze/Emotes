		...
		if (!defaultConfigFile.exists()) {
			...
			this.getConfig()
					.set("language-string.warning.sameworld",
							"&7[&6Emotes&7] &bYou have just been emoted by&c <sender>&b,&c <distance> &1blocks away!");
			this.getConfig()
		...
		if (this.getConfig().getBoolean("use-default-emotes") == true) {
			...
			if (emoteHugSection == null) {
				...
				emoteHugSection.set("sp-message",
						"<s> runs up to the nearest tree and hugs it!");
			...
			if (emoteKickSection == null) {
				...
				emoteKickSection.set("description", "Fly-kick!");
